...
namespace Tiktack.Web.ApiML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\aleh_khantsevich\Desktop\sentiment labelled sentences\wikipedia-detox-250-line-data.tsv";
        private static string MODEL_FILEPATH = @"../../../../Tiktack.Web.ApiML.Model/MLModel.zip";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var trainer = mlContext.BinaryClassification.Trainers.SgdCalibrated(new SgdCalibratedTrainer.Options() { L2Regularization = 1E-06f, ConvergenceTolerance = 0.001f, NumberOfIterations = 10, Shuffle = false, LabelColumnName = "Sentiment", FeatureColumnName = "Features" });
